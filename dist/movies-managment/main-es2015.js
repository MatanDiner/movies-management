...
let AppComponent = class AppComponent {
    ...
    ngOnInit() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            this.movies = yield this.moviesService.getMovies();
...
let MovieAddComponent = class MovieAddComponent {
    constructor(builder, moviesService) {
        this.moviesService = moviesService;
...
MovieDeleteComponent.ctorParameters = () => [
    { type: _services_movies_service__WEBPACK_IMPORTED_MODULE_2__["MoviesService"] }
];
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
MovieEditComponent.ctorParameters = () => [
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
    { type: _services_movies_service__WEBPACK_IMPORTED_MODULE_3__["MoviesService"] }
];
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
let MoviesService = class MoviesService {
    ...
    getMovies() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const response = yield fetch(this.dbUrl);
    ...
    editMovie(mId, updatedMovie) {
        ...
        const movie = Object.assign({}, this.movies[index]);
